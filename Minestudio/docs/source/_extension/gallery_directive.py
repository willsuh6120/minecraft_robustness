...
This file is part of the pydata-sphinx-theme.
"""
...
class GalleryGridDirective(SphinxDirective):
    ...
    option_spec: ClassVar[dict[str, Any]] = {
        ...
        "center-rows": directives.flag,  # Add this line
    }
    ...
    def run(self) -> List[nodes.Node]:
        ...
        if "center-rows" in self.options:  # Add these lines
            options["class-row"] = "justify-content-center" # Add these lines
