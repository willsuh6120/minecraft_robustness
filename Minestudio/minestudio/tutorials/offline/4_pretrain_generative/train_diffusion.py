...
def main(args):
    ...
    mine_policy = VPTDiffusionPolicy(policy_kwargs=convert_to_normal(args.policy), action_kwargs=convert_to_normal(args.action), scheduler_kwargs=convert_to_normal(args.scheduler))
    ...
    mine_lightning = MineLightning(
        ...
        callbacks=[
            DiffusionCallback(convert_to_normal(args.scheduler)),
        ], 
